...
window.onload = function() {
  ...
  // Get all the span elements inside the 'word-advisor' div
  var spans = document.querySelectorAll('.word-advisor span');

  // Add a click event listener to each span
  spans.forEach(function(span) {
      span.addEventListener('click', function() {
          // Append the text content of the span to the value of the input boxes
          searchBox.value += ' ' + this.textContent;
          keywordBox.value += ' ' + this.textContent;
      });
  });
};